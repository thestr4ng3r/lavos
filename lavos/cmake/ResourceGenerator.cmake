...
function(generate_resources)
	set(options SETUP GENERATE_HEADER GENERATE_SOURCE BINARY)
	...
	if(RESOURCE_GENERATOR_GENERATE_SOURCE)
		...
		message("file RELATIVE_PATH RESOURCE_GENERATOR_HEADER_FILE_RELATIVE ${RESOURCE_GENERATOR_HEADER_FILE_RELATIVE_PATH} ${RESOURCE_GENERATOR_HEADER_FILE}")
	...
	if(RESOURCE_GENERATOR_SETUP)
		set(GENERATE_RESOURCES_ARGS "")
		if(RESOURCE_GENERATOR_BINARY)
			set(GENERATE_RESOURCES_ARGS "${GENERATE_RESOURCES_ARGS} BINARY")
		endif()
		set(GENERATE_RESOURCES_ARGS "${GENERATE_RESOURCES_ARGS}
				RELATIVE_PATH \"${RESOURCE_GENERATOR_RELATIVE_PATH}\"
				HEADER_FILE \"${RESOURCE_GENERATOR_HEADER_FILE}\"
				HEADER_FILE_RELATIVE_PATH \"${RESOURCE_GENERATOR_HEADER_FILE_RELATIVE_PATH}\"
				SOURCE_FILE \"${RESOURCE_GENERATOR_SOURCE_FILE}\"
				FUNCTION_PREFIX \"${RESOURCE_GENERATOR_FUNCTION_PREFIX}\"
				FUNCTION_PREFIX \"${RESOURCE_GENERATOR_FUNCTION_PREFIX}\"
				TYPE \"${RESOURCE_GENERATOR_TYPE}\"
				FILES ${RESOURCE_GENERATOR_FILES}")
