...
#include "indexbuffer_application.h"
...
void IndexBufferApplication::InitVulkan()
{
...
void IndexBufferApplication::CreateRenderPasses()
{
...
vk::ShaderModule IndexBufferApplication::CreateShaderModule(const std::vector<char> &code)
{
...
void IndexBufferApplication::CreatePipeline()
{
...
void IndexBufferApplication::CreateVertexBuffer()
{
...
void IndexBufferApplication::CreateIndexBuffer()
{
	auto device = engine->GetVkDevice();
...
void IndexBufferApplication::CreateFramebuffers()
{
...
void IndexBufferApplication::CreateCommandPool()
{
...
void IndexBufferApplication::CreateCommandBuffers()
{
...
void IndexBufferApplication::DrawFrame(uint32_t image_index)
{
...
void IndexBufferApplication::RecreateSwapchain()
{
...
void IndexBufferApplication::CleanupSwapchain()
{
	auto device = engine->GetVkDevice();
...
void IndexBufferApplication::CleanupApplication()
{
	auto device = engine->GetVkDevice();
